...
FalknerGroup:
	...
	db  12, PIDGEY,  NO_ITEM,  TACKLE, MUD_SLAP, QUICK_ATTACK, PECK
	db  14, NOCTOWL, BERRY,    TACKLE, MUD_SLAP, GROWL, GUST
	db -1 ; end
...
JasmineGroup:
	...
	db 36, SCIZOR,   FOCUS_BAND,  XSCISSOR, METAL_CLAW, SLASH, SWORDS_DANCE
	...
	db 38, SCIZOR,   FOCUS_BAND,  XSCISSOR, METAL_CLAW, AGILITY, SWORDS_DANCE
	...
	db 55, SCIZOR,     FOCUS_BAND,    XSCISSOR, SWORDS_DANCE, STEEL_WING, LIGHT_SCREEN
...
ChuckGroup:
	...
	db 35, PINSIR,    NO_ITEM,      ROCK_SMASH, XSCISSOR, VICEGRIP, HARDEN
	...
	db 37, PINSIR,     NO_ITEM,       SUBMISSION, XSCISSOR, STRENGTH, SWORDS_DANCE
	...
	db 53, PINSIR,     NO_ITEM,       SUBMISSION, XSCISSOR, STRENGTH, SWORDS_DANCE
...
WillGroup:
	...
	db "WILL@", TRAINERTYPE_ITEM_MOVES
		db 66, GIRAFARIG
			db LEFTOVERS
            db PSYCHIC_M, EARTHQUAKE, BODY_SLAM, CURSE
        db 67, SLOWKING
			db LEFTOVERS
...
BrunoGroup:
	...
	db 53, HITMONTOP,   NO_ITEM,        REST, SLEEP_TALK, CURSE, MACH_PUNCH
	...
	db "BRUNO@", TRAINERTYPE_ITEM_MOVES
		db 67, HITMONCHAN
			db NO_ITEM
            db HI_JUMP_KICK, BODY_SLAM, COUNTER, THIEF
        db 68, POLIWRATH
			db LEFTOVERS
            db BELLY_DRUM, LOVELY_KISS, BODY_SLAM, HYDRO_PUMP
        db 67, HERACROSS
			db LEFTOVERS
            db CROSS_CHOP, MEGAHORN, SLEEP_TALK, REST
        db 68, HITMONLEE
			db MIRACLEBERRY
            db HI_JUMP_KICK, BODY_SLAM, DOUBLE_EDGE, MACH_PUNCH
        db 67, HITMONTOP
			db LEFTOVERS
            db REST, SLEEP_TALK, CURSE, MACH_PUNCH
        db 68, MACHAMP
			db LEFTOVERS
...
ChampionGroup:
	...
	db 55, TYRANITAR,   HARD_STONE,     CRUNCH, CURSE, ROCK_SLIDE, EARTHQUAKE
	...
	; CHAMPION (2) Rematch
	db "LANCE@", TRAINERTYPE_DVS | TRAINERTYPE_ITEM_MOVES
		db 69, TYRANITAR
			db $dc, $dd
			db QUICK_CLAW
            db CRUNCH, ROCK_SLIDE, EARTHQUAKE, PURSUIT
        db 68, DRAGONITE
			db $dc, $dd
			db MIRACLEBERRY
            db BLIZZARD, FIRE_BLAST, THUNDER_WAVE, THUNDER
        db 69, GYARADOS
			db $cf, $dd
			db LEFTOVERS
            db EARTHQUAKE, THUNDER, HYDRO_PUMP, DOUBLE_EDGE
        db 68, CHARIZARD
			db $dc, $dd
			db LEFTOVERS
            db FIRE_BLAST, ROCK_SLIDE, EARTHQUAKE, BELLY_DRUM
        db 69, AERODACTYL
			db $dc, $dd
			db SCOPE_LENS
...
BlaineGroup:
	...
	db 67, MAGCARGO,   MIRACLEBERRY,   FIRE_BLAST, ROCK_SLIDE, SOLARBEAM, SUNNY_DAY
...
BlueGroup:
	...
	db 69, PIDGEOT,   MIRACLEBERRY,  DOUBLE_EDGE, REFLECT, REST, SLEEP_TALK
	...
	; BLUE (2)
	db "BLUE@", TRAINERTYPE_ITEM_MOVES
	db 84, PIDGEOT,   NO_ITEM,       BODY_SLAM, REFLECT, THIEF, SKY_ATTACK
	db 76, ALAKAZAM,  TWISTEDSPOON,  THUNDERPUNCH, RECOVER, PSYCHIC_M, SHADOW_BALL
	db 76, RHYDON,    QUICK_CLAW,    ROCK_SLIDE, EARTHQUAKE, IRON_TAIL, CRUNCH
	db 76, EXEGGUTOR, LEFTOVERS,     EXPLOSION, SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN
	db 77, GYARADOS,  MIRACLEBERRY,  HYDRO_PUMP, DOUBLE_EDGE, EARTHQUAKE, REVERSAL
	db 77, ARCANINE,  PINK_BOW,      FLAMETHROWER, CURSE, CRUNCH, EXTREMESPEED
	db -1 ; end
OfficerGroup:
	; OFFICER (1)
...
BossGroup:
	...
	db 80, DUGTRIO,   LEFTOVERS, EARTHQUAKE, ROCK_SLIDE, SCREECH, SUBSTITUTE
	db 81, NIDOQUEEN, LEFTOVERS, EARTHQUAKE, ICE_BEAM, SLUDGE_BOMB, MOONLIGHT
	db 81, MURKROW,   LEFTOVERS, PURSUIT, FAINT_ATTACK, DRILL_PECK, SKY_ATTACK
	db 80, KANGASKHAN,LEFTOVERS, CURSE, REST, BODY_SLAM, SLEEP_TALK
	db 82, NIDOKING,  LEFTOVERS, EARTHQUAKE, THUNDERBOLT, SLUDGE_BOMB, FIRE_BLAST
	db 82, RHYDON,    LEFTOVERS, EARTHQUAKE, ROCK_SLIDE, CURSE, SURF
	db -1 ; end
...
PKMNTrainerFGroup:
	...
	db "V@", TRAINERTYPE_NICKNAME | TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
		...
		db 100, ARTICUNO	
				...
				dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
				db LEFTOVERS
				db TOXIC, ICE_BEAM, REST, SLEEP_TALK
		db 100, ZAPDOS
				db "@TWO@"
				db $fd, PERFECT_DV ; atk|def, spd|spc
				dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
				db LEFTOVERS
				db REST, SLEEP_TALK, THUNDERBOLT, HIDDEN_POWER
		db 100, MOLTRES
				db "@THREE@"
				db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
				dw $01FE, $01FE, $01FE, $01FE, $01FE ; hp, atk, def, spd, spc
