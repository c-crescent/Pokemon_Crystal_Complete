...
WillGroup:
	...
	db "WILL@", TRAINERTYPE_ITEM_MOVES
		db 66, GIRAFARIG
			db MIRACLEBERRY
            db THUNDER, EARTHQUAKE, PSYCHIC_M, SHADOW_BALL
        db 67, SLOWKING
			db LEFTOVERS
            db FLAMETHROWER, SURF, THUNDER_WAVE, REST
        db 67, EXEGGUTOR
			db MIRACLEBERRY
            db SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, EXPLOSION
        db 67, ESPEON
			db LEFTOVERS
            db GROWTH, PSYCHIC_M, MORNING_SUN, SHADOW_BALL
        db 66, SLOWBRO
			db LEFTOVERS
            db FLAMETHROWER, SURF, PSYCHIC_M, AMNESIA
        db 68, XATU
			db TWISTEDSPOON
            db DRILL_PECK, NIGHT_SHADE, REST, SLEEP_TALK
	db -1 ; end
